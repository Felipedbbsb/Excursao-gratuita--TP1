...
class TUIdioma {
private:
    const static int VALOR_VALIDO   = "Ingles";   // Definição de constante para evitar número mágico.
    const static int VALOR_INVALIDO = "Blablabla";   // Definição de constante para evitar número mágico.
...
class TUNota {
private:
    const static int VALOR_VALIDO   = "0";   // Definição de constante para evitar número mágico.
    const static int VALOR_INVALIDO = "7";   // Definição de constante para evitar número mágico.
...
class TUDuracao {
private:
    const static int VALOR_VALIDO   = "30";   // Definição de constante para evitar número mágico.
    const static int VALOR_INVALIDO = "0";   // Definição de constante para evitar número mágico.
...
class TUDescricao {
private:
    const static int VALOR_VALIDO   = "Teste";   // Definição de constante para evitar número mágico.
    const static int VALOR_INVALIDO = "tes.. te";   // Definição de constante para evitar número mágico.
